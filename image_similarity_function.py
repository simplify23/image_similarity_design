...
def ORB_img_similarity(img1_path,img2_path):
    ...
    try:
        ...
        #print("ORB计算的相似度为 ",similary)
        #print("good匹配: ",len(good),"matches匹配:",len(matches))
        return similary
...
def calc_similar(li, ri):
    #print("直方图计算的相似度为：",sum(hist_similar(l.histogram(), r.histogram()) for l, r in zip(split_image(li), split_image(ri))) / 16.0)
